...
def home():
    ...
    if form.validate_on_submit():
        entry = Entry(item=form.item.data.capitalize(), category=form.category.data.capitalize(), price=form.price.data, location=form.location.data.capitalize(), date_posted=form.date.data, user_id=current_user.id)
